...
export default function Debug() {
  const handleClick_debug_npz = async () => {
    ...
    const file = import.meta.env.VITE_PATH + "/datasets/03-image-classification/kmnist/kmnist-train-imgs.npz"
  ...
  const handleClick_debug = async () => {
    ...
    const res_npy = await _npyjs_.load(
      import.meta.env.VITE_PATH + "/datasets/03-image-classification/kmnist/kmnist-train-imgs/arr_0.npy",
    )
    console.log(res_npy)
  }
  ...
  return (
    <>
      <Container>
        ...
        <Row>
          <Col>
            <Button className={"me-3"} onClick={handleClick_debug}>
              Debug npy with npyjs
            </Button>
