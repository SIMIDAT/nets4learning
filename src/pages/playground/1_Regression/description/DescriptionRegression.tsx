          ...
          <Card className={'mt-3'}>
            ...
            <Card.Body>
              ...
              <ol style={{ listStyleType: 'none' }}>
                <li><N4LLatex>$Y$ representa el precio de la casa.</N4LLatex></li>
                <li><N4LLatex>X representa el tamaño de la casa.</N4LLatex></li>
                <li><N4LLatex>$\beta_0$ es el intercepto, que indica el valor de Y cuando X es igual a cero.</N4LLatex></li>
                <li><N4LLatex>$\beta_1$ es la pendiente de la línea de regresión, que representa el cambio en el precio de la casa asociado a un incremento unitario en el tamaño de la casa.</N4LLatex></li>
                <li><N4LLatex>$\epsilon$ es el término de error, que representa la variabilidad no explicada por el modelo.</N4LLatex></li>
              </ol>
              <p><N4LLatex>El objetivo del modelo de regresión lineal es estimar los valores de los coeficientes $\beta_0$ y $\beta_1$ a partir de los datos observados para obtener una línea recta que mejor se ajuste a los puntos en el gráfico
                de dispersión de las variables.</N4LLatex></p>
              <p><N4LLatex>Una vez que el modelo está ajustado, podemos utilizarlo para predecir el precio de una casa desconocida dada su área en metros cuadrados. Simplemente debemos sustituir el valor de $x$ en la ecuación y calcular el
                valor predicho de $Y$.</N4LLatex></p>
              <p><N4LLatex>Cabe destacar que este ejemplo es un caso simplificado de regresión lineal simple, y en la práctica los modelos pueden involucrar múltiples variables predictoras y considerar interacciones entre ellas.</N4LLatex></p>
            </Card.Body>
          </Card>
        </Col>
      </Row>
