 ...
 */
type PropsTabularClassificationEditorLayers = {
  layers      : _Types.Layer_t[],
  setLayers   : React.Dispatch<React.SetStateAction<_Types.Layer_t[]>>,
 ...
 * @returns 
 */
export default function TabularClassificationEditorLayers(props: PropsTabularClassificationEditorLayers) {
  const {
    layers,
    setLayers,
    datasets,
  ...
  useEffect(() => {
    const changeUnitsLastLayer = (old_layer: _Types.Layer_t[], units_last_layer: number) => {
                  ...
                  <Form.Group className="mt-3" controlId={'formUnitsLayer' + index}>
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => handleChange_Layer(index, {
                        ...
                        activation: item.activation || 'relu',
                      })} />
                  </Form.Group>
                  {/* ACTIVATION FUNCTION */}
