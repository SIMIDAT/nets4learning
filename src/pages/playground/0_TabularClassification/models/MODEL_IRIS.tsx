...
`}
  ...
  async DATASETS(): Promise<_Types.DatasetProcessed_t[]> {
    const path_dataset = import.meta.env.VITE_PATH + '/models/00-tabular-classification/iris/'
    ...
    const item: _Types.DatasetProcessed_t = {
      ...
      data_processed      : {
        ...
        attributes        : [
          // @formatter:off
          { type: 'float32', name: 'sepal_length',  options: []   },
          { type: 'float32', name: 'sepal_width',   options: []   },
          { type: 'float32', name: 'petal_length',  options: []   },
          { type: 'float32', name: 'petal_width',   options: []   },
          // @formatter:on
        ],
      },
    }
  ...
  DEFAULT_LAYERS(): _Types.Layer_t[] {
    return [
      ...
      { _class: 'dense', units: 10, activation: 'relu' },
      { _class: 'dense', units: 3, activation: 'softmax' },
    ]
  }
