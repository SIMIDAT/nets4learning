    ...
    <>
      <Accordion defaultValue={"equations"} defaultActiveKey={"equations"}>
        <Accordion.Item eventKey={"functions-optimizers"}>
          ...
          <Accordion.Body>
            <p>
              <Trans i18nKey={"pages.glossary.optimization-functions.text-1"} />
            </p>
            <p>
              <Trans i18nKey={"pages.glossary.optimization-functions.text-2"} />
            </p>
            <Table striped bordered hover responsive={true}>
              <thead>
                <tr>
                  <th>
                    <Trans i18nKey={"pages.glossary.table-head.function"} />
                  </th>
                  {/*<th><Trans i18nKey={"pages.glossary.table-head.references"}/</th>*/}
                  <th>
                    <Trans i18nKey={"pages.glossary.table-head.description"} />
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.sgd.description"} />
                  </td>
                </tr>
                <tr>
                  <th>Momentum</th>
                  {/*<td></td>*/}
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.momentum.description"} />
                  </td>
                </tr>
                <tr>
                  <th>AdaGrad</th>
                  ...
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.adagrad.description"} />
                  </td>
                </tr>
                <tr>
                  <th>Adadelta</th>
                  ...
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.adadelta.description"} />
                  </td>
                </tr>
                <tr>
                  <th>Adam</th>
                  ...
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.adam.description"} />
                  </td>
                </tr>
                <tr>
                  <th>Adamax</th>
                  {/*<td><Trans i18nKey={"pages.glossary.optimization-functions.table.adam.references"} /></td>*/}
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.adamax.description"} />
                  </td>
                </tr>
                <tr>
                  <th>RMSProp</th>
                  ...
                  <td>
                    <Trans i18nKey={"pages.glossary.optimization-functions.table.rmsprop.description"} />
                  </td>
                </tr>
              </tbody>
            </Table>
            ...
            <ol>
              <li>
                <a
                  ...
                  rel="noreferrer"
                  className="link-info"
                  href="https://js.tensorflow.org/api/3.14.0/#Training-Optimizers"
                >
                  TensorFlow JS. Training / Optimizers
                </a>
              </li>
            </ol>
          </Accordion.Body>
