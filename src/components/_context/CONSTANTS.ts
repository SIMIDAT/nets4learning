...
export const LIST_PLOTS = Object.entries(E_PLOTS).map(([_key, value]: [string, string]) => value)

/**
 *
 * @type {_Types.DataframePlotConfig_t}
 */
export const DEFAULT_DATAFRAME_PLOT_CONFIG: _Types.DataframePlotConfig_t = {
