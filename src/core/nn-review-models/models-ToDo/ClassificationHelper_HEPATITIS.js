...
export const MODEL_HEPATITIS = {
  ...
  // @formatter:off
  FORM             : [
    { type: "label-encoder", name: "sex",             options: [{ value: "1", text: "Male" }, { value: "2", text: "Female" }] },
    { type: "label-encoder", name: "steroid",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "antivirals",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "fatigue",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "malaise",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "anorexia",        options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "liver_big",       options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "liver_firm",      options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "spleen_palpable", options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "spiders",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "ascites",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    { type: "label-encoder", name: "varices",         options: [{ value: "1", text: "No"   }, { value: "2", text: "Yes"    }] },
    // ...
  ],
  // @formatter:on
  TABLE_HEADER: [
