    ...
    configure: (webpackConfig) => {
      ...
      webpackConfig.optimization = {
        ...
        minimizer: [new TerserPlugin({
          terserOptions: {
            keep_fnames: /binaryAccuracy|binaryCrossentropy|categoricalAccuracy|categoricalCrossentropy|cosineProximity|meanAbsoluteError|meanAbsolutePercentageError|meanSquaredError|precision|recall|sparseCategoricalAccuracy/ // Las funciones que quieres proteger
          }
        })]
      }
